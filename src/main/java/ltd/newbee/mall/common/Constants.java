...
//    public final static String FILE_UPLOAD_DIC = "/opt/images/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static int GOODS_SEARCH_PAGE_LIMIT = 15;//搜索分页的默认条数(每页15条)
